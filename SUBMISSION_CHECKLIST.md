...
- [x] Dataset modality and label remapping verified
- [x] Reproducible training pipeline implemented
- [x] Evaluation pipeline implemented
- [x] Visualization pipeline implemented
- [x] Debug checkpoint produced
- [x] Debug val/test metrics produced
